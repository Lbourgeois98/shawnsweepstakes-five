...
export default function CustomPage() {
  ...
  return (
    <div style={{ padding: "40px", fontFamily: "Arial, sans-serif", color: "white", backgroundColor: "#000" }}>
      {/* Deposit button */}
      <button
        onClick={openDeposit}
        style={{
          padding: "12px 24px",
          fontSize: "16px",
          backgroundColor: "rgba(250,10,10,0.9)",
          border: "none",
          borderRadius: "8px",
          color: "white",
          cursor: "pointer",
      ...
      {/* Games container */}
      <div id="games" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "25px" }}></div>
    </div>
  );
}
